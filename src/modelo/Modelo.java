...
public class Modelo extends Conexion {
    ...
    public boolean descontarStock(int ext_end, int descuento, int id_cafe, int id_coffe, int id_end, int id_leche, int id_vaso, int valor_venta) {

        switch (id_cafe) {

            case 1://espresso
                try {
                    PreparedStatement pstm1 = this.getConexion().prepareStatement("UPDATE cafe SET stock_c = stock_c-1 WHERE id_coffe =1;"); // Stock Cafe 
                    PreparedStatement pstm9 = this.getConexion().prepareStatement("UPDATE vaso SET stock_vaso = stock_vaso-1 WHERE id_vaso =1;");//Stock Vaso Chico
                    int r1 = pstm1.executeUpdate();
                    int r9 = pstm9.executeUpdate();
                    pstm1.close();
                    pstm9.close();
            ...
            case 2://americao
                try {
                    ...
                    int r1 = pstm1.executeUpdate();
                    if (id_vaso == 2) {
                        PreparedStatement pstm10 = this.getConexion().prepareStatement("UPDATE vaso SET stock_vaso = stock_vaso-1 WHERE id_vaso =2;");//Stock Vaso Mediano
                        int r10 = pstm10.executeUpdate();
                        pstm10.close();
                    }
                    if (id_vaso == 3) {
                        PreparedStatement pstm21 = this.getConexion().prepareStatement("UPDATE cafe SET stock_c = stock_c-1 WHERE id_coffe =1;"); // Stock Cafe
                        PreparedStatement pstm11 = this.getConexion().prepareStatement("UPDATE vaso SET stock_vaso = stock_vaso-1 WHERE id_vaso =3;"); //Stock Vaso Grande
                        int r21 = pstm21.executeUpdate();
                        int r11 = pstm11.executeUpdate();
                        pstm21.close();
                        pstm11.close();
                    }
        ...
        switch (id_end) {
            ...
            case 1://blanca
                try {
                    PreparedStatement pstm2 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =1;");//Stock azucar blanca  
                    int r2 = pstm2.executeUpdate();
                    if (ext_end == 1) {
                        PreparedStatement pstm22 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =1;");//Stock azucar blanca  
                        int r22 = pstm22.executeUpdate();
                        pstm22.close();
                    }
                    pstm2.close();
                    getConexion().close();
            ...
            case 2://rubia
                try {
                    PreparedStatement pstm2 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =2;");//Stock azucar rubia  
                    int r2 = pstm2.executeUpdate();
                    if (ext_end == 1) {
                        PreparedStatement pstm22 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =2;");//Stock azucar rubia  
                        int r22 = pstm22.executeUpdate();
                        pstm22.close();
                    }
                    pstm2.close();
            ...
            case 3://stevia
                try {
                    PreparedStatement pstm2 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =3;");//Stock stevia  
                    int r2 = pstm2.executeUpdate();
                    if (ext_end == 1) {
                        PreparedStatement pstm22 = this.getConexion().prepareStatement("UPDATE endulzante SET stock_end = stock_end-1 WHERE id_end =3;");//Stock stevia  
                        int r22 = pstm22.executeUpdate();
                        pstm22.close();
                    }
                    pstm2.close();
        ...
        switch (id_leche) {
            ...
            case 1://entera
                try {
                    if (id_cafe == 3) {//capuccino - vaso mediano
                        PreparedStatement pstm5 = this.getConexion().prepareStatement("UPDATE leche SET stock_leche = stock_leche-1 WHERE id_leche =1;");//Stock Leche Entera    
                        int r5 = pstm5.executeUpdate();

                        if (id_vaso == 3) {//vaso grande
                            int r6 = pstm5.executeUpdate();

                        }
                        pstm5.close();
                        getConexion().close();
                    }
                    if (id_cafe == 4) {//cortado - vaso mediano
                        PreparedStatement pstm5 = this.getConexion().prepareStatement("UPDATE leche SET stock_leche = stock_leche-1 WHERE id_leche =1;");//Stock Leche Entera    
                        int r5 = pstm5.executeUpdate();
                        int r7 = pstm5.executeUpdate();
            ...
            case 2://descremada
                try {
                    if (id_cafe == 3) {//capuccino - vaso mediano
                        PreparedStatement pstm5 = this.getConexion().prepareStatement("UPDATE leche SET stock_leche = stock_leche-1 WHERE id_leche =2;");//Stock Leche Entera    
                        int r5 = pstm5.executeUpdate();
            ...
            case 3://soya
                try {
                    if (id_cafe == 3) {//capuccino - vaso mediano
                        PreparedStatement pstm5 = this.getConexion().prepareStatement("UPDATE leche SET stock_leche = stock_leche-1 WHERE id_leche =3;");//Stock Leche Entera    
                        int r5 = pstm5.executeUpdate();
            ...
            case 4://almendra
                try {
                    if (id_cafe == 3) {//capuccino - vaso mediano
                        PreparedStatement pstm5 = this.getConexion().prepareStatement("UPDATE leche SET stock_leche = stock_leche-1 WHERE id_leche =4;");//Stock Leche Entera    
                        int r5 = pstm5.executeUpdate();
